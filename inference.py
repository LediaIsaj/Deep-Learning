...
parser.add_argument('--test_covid_path', type=str, default='./data/val/covid/',
...
parser.add_argument('--trained_model_path', type=str, default='./results/desnenet/epoch10/covid_densenet121_epoch10.pt',
